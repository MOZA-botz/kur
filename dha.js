...
petik = '```'
fake = '©herman Botz'//GANTI NAMA KAMU BEP
ban =[]
...
*Sewa bot?* Chat wa.me/6289616311274`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Moza Botz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
        ...
        case 'command':
               ...
               listmenuu = [`Menu Group`,`Wibu Menu`,`Sticker Menu`,`Islam Menu`,`Serti Menu`,`Cerita Menu`,`Maker Menu`,`Owner Menu`,`Game Menu`,`Fun Menu`,`Downloader`,`Info Menu`,`MenuLainnya`,`Tools Menu`]
               nombor = 1
               startnum = 0
...
*Link Grup : https://chat.whatsapp.com/G2VfeQKzLvaHC2dXcSY9Tt
